...
def main():
    try:
        df = fetch_weather_data(46.5547, 15.6459)  # Maribor coordinates

        raw_weather_data_file = os.path.join(RAW_DATA_DIR, "weather", "raw_weather.csv")
        DataManager.save_to_csv(raw_weather_data_file, df, overwrite=True)
